...
RSpec.describe AddressBook do
  ...
  describe "#remove_entry" do
    ...
    it "makes sure the entry is deleted from address book" do
  ...
  describe '#import_from_csv2' do
    ...
    it "imports the 1st entry" do
      ...
      check_entry(entry_one, "Jason", "234-342-3434", "jason@blocmail.com")
    end
    ...
    it "imports the 2nd entry" do
      ...
      check_entry(entry_two, "Jimmy", "394-232-3432", "jimmy@blocmail.com")
    end
    ...
    it "imports from the 3rd entry" do
      ...
      check_entry(entry_three, "Susan", "233-342-3244" ,"susan@blocmail.com")
    end
  end
